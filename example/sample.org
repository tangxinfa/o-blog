...
See the [[file:Posts/index.html][Posts]] for more details.
...
** Navigation Footer
  ...
  - [[file:{lisp}(ob:path-to-root){/lisp}/roadmap.html][/icon-tasks icon-white/ {lisp}(ob:gettext :roadmap){/lisp}]]
...
#+begin_src org
  ...
  ,  - [[file:{lisp}(format "%s/%s" (ob:path-to-root) (ob:post-htmlfile (ob:get-last-post "Posts" 0))){/lisp}][{lisp}(ob:post-title (ob:get-last-post "Posts" 0)){/lisp}]]
  ,  - [[file:{lisp}(format "%s/%s" (ob:path-to-root) (ob:post-htmlfile (ob:get-last-post "Posts" 1))){/lisp}][{lisp}(ob:post-title (ob:get-last-post "Posts" 1)){/lisp}]]
  ,  - [[file:{lisp}(format "%s/%s" (ob:path-to-root) (ob:post-htmlfile (ob:get-last-post "Posts" 2))){/lisp}][{lisp}(ob:post-title (ob:get-last-post "Posts" 2)){/lisp}]]
  ,  - [[file:{lisp}(format "%s/%s" (ob:path-to-root) (ob:post-htmlfile (ob:get-last-post "Posts" 3))){/lisp}][{lisp}(ob:post-title (ob:get-last-post "Posts" 3)){/lisp}]]
  ,  - [[file:{lisp}(format "%s/%s" (ob:path-to-root) (ob:post-htmlfile (ob:get-last-post "Posts" 4))){/lisp}][{lisp}(ob:post-title (ob:get-last-post "Posts" 4)){/lisp}]]
...
=Posts/2012/08/21_adding-an-image-into-a-post/emacs-logo.png=.
